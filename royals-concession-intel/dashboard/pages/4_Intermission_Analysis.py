...
st.set_page_config(page_title="Intermission Analysis", page_icon="\u23f1\ufe0f", layout="wide")
...
st.title("\u23f1\ufe0f Intermission Analysis")
st.markdown("---")
...
st.subheader("Transaction Velocity Heatmap")
...
st.markdown("---")
st.subheader("Transactions by Game Period")
...
colors = ["#FFD700" if is_int else "#4B0082" for is_int in df_period["is_intermission"]]
...
st.subheader("Stand Intermission Load")
...
st.markdown("---")
st.subheader("Lost Revenue Estimator")
...
# Annual projection: we use the average per-game intermission revenue * improvement * est. ~36 home games/season
...
">
    ...
    <strong style="color:#4B0082; font-size:1.2rem;">Business Impact:</strong>
    <br><br>
